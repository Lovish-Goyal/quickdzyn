      ...
      <main className="min-h-screen bg-white">
        <section className="w-full bg-gradient-to-b from-primary/10 via-white to-white px-6 py-20">
          <div className="mx-auto w-full max-w-[1200px] text-center">
            ...
            <h1 className="mt-4 text-3xl font-semibold text-slate-900">Fetching design...</h1>
          </div>
        </section>
      </main>
    );
  ...
  if (!design) {
    return (
      <main className="min-h-screen bg-white">
        <section className="w-full bg-gradient-to-b from-primary/10 via-white to-white px-6 py-20">
          <div className="mx-auto w-full max-w-[1200px] text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-slate-500">Not Found</p>
            <h1 className="mt-4 text-3xl font-semibold text-slate-900">Design not available</h1>
            <p className="mt-3 text-base text-slate-600">
              The template you are looking for does not exist yet.
            </p>
            <Link
              href="/designs"
